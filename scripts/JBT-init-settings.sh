...
#更改默认地址为192.168.24.10
sed -i 's/192.168.1.1/192.168.24.10/g' package/base-files/files/bin/config_generate
sed -i 's/192.168.1.1/192.168.24.10/g' package/base-files/luci/bin/config_generate
